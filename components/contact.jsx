    ...
    <section id="contact" className="py-24 bg-transparent">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="font-serif text-4xl sm:text-5xl font-bold text-foreground mb-4  text-white">
            Get In Touch
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className="w-full bg-white text-black px-8 py-4 rounded-lg  transition-all font-medium flex items-center justify-center gap-2 group"
            >
              {status === "sending"
                ? "Sending..."
                : status === "success"
